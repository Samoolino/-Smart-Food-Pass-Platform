...
export default function MarketplacePage() {
  ...
  return (
    <ProtectedRoute
      allowedRoles={['admin', 'super_admin', 'sponsor', 'merchant', 'beneficiary']}
      title="Authorized marketplace access"
      description="Marketplace visibility is available only to authenticated roles with valid access to registry, product, plan, and payment pathways."
    >
